...
>- 性能区别原因    
java最终的执行代码并不是可以直接被 CPU 执行的二进制机械码
...
**选择**  
少量数据，用String，单线程操作大量数据用Stringbuilder，多线程操作大量数据用Stringbuffer  
